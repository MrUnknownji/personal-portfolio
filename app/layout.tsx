  ...
  return (
    <html lang="en">
      <body className="overflow-x-hidden w-screen" suppressHydrationWarning>
        {/* Unified background with animated gradients and patterns */}
        <div className="fixed inset-0 z-0 overflow-visible">
          ...
          <div className="absolute top-0 -left-4 w-96 h-96 bg-primary/10 rounded-full filter blur-3xl opacity-20 animate-blob"></div>
          <div className="absolute top-1/4 -right-4 w-96 h-96 bg-accent/10 rounded-full filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
          <div className="absolute bottom-0 left-1/3 w-96 h-96 bg-primary/10 rounded-full filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
