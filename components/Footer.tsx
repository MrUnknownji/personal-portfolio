...
const Footer = () => {
  ...
  return (
    <footer
      ref={footerRef}
      className="w-full bg-gradient-to-b from-secondary via-dark to-dark border-t border-neutral/20 py-12 md:py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
    >
