...
const BEFORE_CODE = [
  {
    ...
    content: (
      <>
        <span className="text-[#6a9955]">{"// What I do?"}</span>
      </>
    ),
  },
  { line: 2, content: <></> },
  {
    ...
    content: (
      <>
        ...
        <span className="text-[#79c0ff]">challenges</span> = {"["}
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <span className="pl-4 text-[#ce9178]">
          &quot;Complex problems&quot;
        </span>
        ,
      </>
  ...
  },
  {
    ...
    content: (
      <>
        <span className="pl-4 text-[#ce9178]">&quot;Scaling issues&quot;</span>,
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <span className="pl-4 text-[#ce9178]">&quot;Legacy code&quot;</span>,
      </>
    ),
  },
  {
  ...
  { line: 9, content: <></> },
  {
    ...
    content: (
      <>
        <span className="text-[#6a9955]">{"// Need a solution?"}</span>
      </>
    ),
  },
];
...
const AFTER_CODE = [
  {
    ...
    content: (
      <>
        <span className="text-[#c586c0]">const</span>{" "}
        <span className="text-[#79c0ff]">Sandeep</span> = {"{"}
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <span className="pl-4 text-[#9cdcfe]">role</span>:{" "}
        <span className="text-[#ce9178]">&quot;Full Stack Dev&quot;</span>,
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <span className="pl-4 text-[#9cdcfe]">expertise</span>: {"["}
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <span className="pl-8 text-[#ce9178]">&quot;React&quot;</span>,{" "}
  ...
  },
  {
    ...
    content: (
      <>
        <span className="pl-8 text-[#ce9178]">&quot;Node.js&quot;</span>,{" "}
  ...
  },
  {
    ...
    content: (
      <>
        <span className="pl-4 text-[#9cdcfe]">solves</span>:{" "}
        <span className="text-[#ce9178]">&quot;Your challenges&quot;</span>,
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <span className="pl-4 text-[#9cdcfe]">status</span>:{" "}
