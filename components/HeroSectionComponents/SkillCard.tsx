    ...
    >
      <div className="relative z-10 flex items-center gap-3">
        <div className="flex items-center justify-center w-8 h-8 rounded-md bg-white/5 text-neutral-400
                        group-hover:text-primary group-hover:bg-primary/10 transition-colors duration-150">
          {icon}
        </div>
        <div className="text-neutral-300 text-sm font-medium tracking-wide group-hover:text-white transition-colors duration-150">
          {text}
        </div>
      </div>
    </div>
