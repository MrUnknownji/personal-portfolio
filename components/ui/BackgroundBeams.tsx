...
export const BackgroundBeams = React.memo(
    ({ className }: { className?: string }) => {
        ...
        useGSAP(() => {
            const gradients = containerRef.current?.querySelectorAll("linearGradient");
            if (gradients) {
                        ...
                        <React.Fragment key={`path-${index}`}>
                            ...
                            <defs>
                                ...
                                >
                                    ...
                                    <stop offset="32.5%" stopColor="#00ff9f"></stop>
                                    <stop offset="100%" stopColor="#00ff9f" stopOpacity="0"></stop>
                                </linearGradient>
                            </defs>
                        </React.Fragment>
                    ))}
