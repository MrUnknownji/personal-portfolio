...
export const projects: Project[] = [
  ...
  },
  {
    ...
    longDescription: "A modern web application that leverages OpenAI's DALL-E API to generate unique images from text descriptions. Features a clean UI, image history, and social sharing capabilities.",
  ...
  },
  {
    ...
    shortDescription: "A modern, responsive portfolio website with dynamic animations.",
    longDescription: "A personal portfolio website built with Next.js and TypeScript, featuring smooth animations, responsive design, and dynamic content loading. Showcases projects, skills, and professional experience.",
    image: "/images/projects/portfolio.jpg",
    technologies: ["Next.js", "TypeScript", "GSAP", "Tailwind CSS", "Framer Motion"],
    features: [
  ...
  },
  {
    ...
    longDescription: "A robust REST API built with Node.js and Express, providing endpoints for task and project management. Features authentication, role-based access control, and comprehensive documentation.",
  ...
  },
  {
    ...
    longDescription: "A comprehensive DevOps dashboard for monitoring application performance, managing deployments, and tracking infrastructure health. Integrates with popular CI/CD tools and cloud providers.",
    image: "/images/projects/devops.jpg",
    technologies: ["React", "Docker", "Kubernetes", "Grafana", "Prometheus", "AWS"],
    features: [
